...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/aidou/css/stepper.css" />
        ...
        <script type="text/javascript" src="/aidou/javascript/jquery.fs.stepper.js"></script>
        <title></title>
    </head>
    <body>
        <div class="main_contain">
            ...
            <!--            <div>
                            <button id="aidou_btn" type="button" class="button_style btn btn-primary btn-lg">艾豆</button>
                            <button id="zhaodajie_btn" type="button" class="button_style btn btn-primary btn-lg">赵大姐</button>
                            <button id="other_btn" type="button" class="button_style btn btn-primary btn-lg">其他</button>
                        </div>-->
            <form id="order" name="order" action="/aidou/wechat/orderlist.do" method="get">
                <div id="aidou">
...
<!--                                <td class="order_td_0">${other.id}</td>
                ...
                <button id="order_btn" type="button" class="order_btn btn btn-primary btn-lg" >提交订单</button>
            </form>
        </div>
    </body>
</html>
